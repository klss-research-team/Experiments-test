...
# TODO: define function to process text_responses output from LLM to feed into our software
def bidding_projection(text_repsonses: List[str], start_tag: str, end_tag: str, check_think_tag: bool = False, return_tag: bool = False, return_whole_response: bool = False) -> List[str]:
    """
    A function to process the text_responses

    Parameters
    ----------
    text_responses: str
        the list of text_responses to be procssed (list of str)
    start_tag : str
        the start tag to be used for projection, e.g., "<action>"
    end_tag: str
        the end tag to be used for projection, e.g., "</action>"
    check_think_tag: bool
        whether to check the <think>...</think> tag, default False
    return_tag: bool
        whether to return the tag, default is False
    return_whole_response: bool
        whether to return the whole response, default is False
