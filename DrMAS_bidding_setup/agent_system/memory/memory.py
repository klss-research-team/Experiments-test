...
# TODO: redo the whole BiddingMemory(BaseMemory) class cuz I messed up somwehre. can keep SimpleMemory(BaseMemory)
...
class BiddingMemory(BaseMemory):
    ...
    def store(self, record: Dict[str, List[Any]]):
        ...
        # TODO: check over, rn no change from OG DrMAS
        def fetch(
                self,
                history_length: int,
                obs_key: str,
